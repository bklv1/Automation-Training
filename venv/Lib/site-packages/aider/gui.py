...
class GUI:
    ...
    def do_run_test_recorder(self):
        ...
        if self.button("Run Test Recorder", help=text):
            ...
            # Run the TestRecorder using Maven
            run_command = "mvn exec:java -Dexec.mainClass=TestRecorder"
            process = subprocess.Popen(run_command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True, cwd=cwd)
