...
class GUI:
    ...
    def do_sidebar(self):
        with st.sidebar:
            ...
            if st.button("Submit"):
                ...
                prompt = f"""For this part of html page {html_page},  As a senior automation qa you have to automate the test scenario using the currently implementeded methods and only implement what is missing. Please follow the practices used inside the codebase. Here are the test steps:{test_case}"""
    ...
    def do_run_test_recorder(self):
        text = "Runs the Python Test Recorder"
    ...
    def get_test_recorder_output(self):
        return getattr(self.state, 'test_recorder_output', "Test Recorder has not been run yet.")

    def get_test_recorder_data(self):
