...
class GUI:
    ...
    def do_run_test_recorder(self):
        ...
        if self.button("Run Test Recorder", help=text):
            import io
            import sys
            from test_recorder import run_test_recorder
            ...
            try:
                page_clicks_map, page_hovers_map = run_test_recorder()
            except Exception as e:
                self.error(f"Test Recorder error: {str(e)}")
            finally:
                # Restore stdout
            ...
            self.state.test_recorder_output = output
