...
class GUI:
    ...
    def do_run_test_recorder(self):
        ...
        if self.button("Run Test Recorder", help=text):
            ...
            # Construct the full path to TestRecorder.java
            test_recorder_path = os.path.join(cwd, "src", "main", "java", "TestRecorder.java")

            # Compile the Java file
            compile_command = f"javac -cp .;{cwd}\\src\\main\\java {test_recorder_path}"
            subprocess.run(compile_command, shell=True, check=True)

            # Run the compiled Java class
            run_command = f"java -cp .;{cwd}\\src\\main\\java TestRecorder"
            process = subprocess.Popen(run_command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
